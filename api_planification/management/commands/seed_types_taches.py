...
class Command(BaseCommand):
    help = 'Peuple la table TypeTache avec les types de tâches standards'
    ...
    def handle(self, *args, **options):
        ...
        for data in types_taches:
            obj, created = TypeTache.objects.get_or_create(
            ...
            if created:
                ...
                existing_count += 1
                self.stdout.write(f'  Type existant: {obj.nom_tache}')

        self.stdout.write('')
        self.stdout.write(self.style.SUCCESS(
            f'Peuplement terminé: {created_count} types créés, {existing_count} déjà existants'
        ))
